...
def eventa():
    ...
    answer2 = 1 - answer
    return answer2
print("the probability of event a is ",eventa())
def eventb():
    prob = 1/6
    answer = prob**12
    answer1 = answer*2
    answer2 = 1 - answer1
    return answer2
print("the probability of event b is ", eventb())
def eventc():
    prob = 1/6
    answer = prob**18
    answer1 = answer*3
    answer2 = 1 - answer1
    return answer2
print("the probability of event b is ", eventc())
ans = more_likely(eventa(),eventb(),eventc())
if eventa() == ans:
